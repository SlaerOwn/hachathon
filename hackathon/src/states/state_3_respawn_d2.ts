...
function respawn(door_1: Entity, door_2: Entity, door_3: Entity, room_3: Entity, appendix: Entity, door_4: Entity, door_5: Entity){
...
function state_3_respawn_d2(door_1: Entity, door_2: Entity, door_3: Entity, room_3: Entity, appendix: Entity, door_4: Entity, door_5: Entity) {
    ...
    if(!close_animation_d1.playing){
        ...
        door_2.addComponent(
            new utils.Delay(1000, () => {
                respawn(door_1, door_2, door_3, room_3, appendix, door_4, door_5)
            })
        )
    }else{
        respawn(door_1, door_2, door_3, room_3, appendix, door_4, door_5)
