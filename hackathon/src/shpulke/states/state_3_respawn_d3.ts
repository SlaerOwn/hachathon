...
function respawn(door_1: Entity, door_2: Entity, door_3: Entity, door3_1: Entity, room_3: Entity, appendix: Entity, door_4: Entity, door_5: Entity, trigger: Entity, room1: Entity){
    ...
    door_1.getComponent(Transform).position.y = 1
...
function state_3_respawn_d3(door_1: Entity, door_2: Entity, door_3: Entity, door3_1: Entity, room_3: Entity, appendix: Entity, door_4: Entity, door_5: Entity, trigger: Entity, room1: Entity) {
    ...
    if(!close_animation_d2.playing){
        ...
        door_2.addComponent(
            new utils.Delay(1000, () => {
                respawn(door_1, door_2, door_3, door3_1, room_3, appendix, door_4, door_5, trigger, room1)
            })
        )
    }else{
        respawn(door_1, door_2, door_3, door3_1, room_3, appendix, door_4, door_5, trigger, room1)
